...
public class CalendarVO {
	...
	private boolean allDay;  //이상 캘린더 생성시 필수적인 요소들(front에서 ajax로 받아올 자료들)
	...
	public String toString() {
		return "CalendarVO [id=" + id + ", title=" + title + ", start=" + start + ", end=" + end + ", description="
				+ description + ", color=" + color + ", dataEventColor=" + dataEventColor + ", allDay=" + allDay
				+ ", calendarid=" + calendarid + ", teamid=" + teamid + ", memberId=" + memberId + "]";
	}
